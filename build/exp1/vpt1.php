...
<p class="mytitle" style="color: #1f505e;">Explanation with Audio-Visual&nbsp;&nbsp;<img src="images/audio.png" style="height: 33px; width: 33px" /></p>
<p>
<table border="0" width="100%">
   <tr>
       <td align="left"><a href="autolevel_mid.php"><img src="images/back.gif" border=0 width=50 height=20 ALT="Back"></a></td>
       <td align="right"><a href="vpt2.php"><img src="images/next3.gif" border=0 width=50 height=20 ALT="Next"></a></td>
   </tr>
</table>
</p>

<p align="center">
<img src="images/tripod2.jpg" border=0 width=500 height=500 /><p>

<p>
<scan style="font-weight: bold; font-size: 20px; color: #7E2217;">Tripod:</scan><scan style="font-size: 20px; color: #7D2252;"> It is used to fix the instrument.</scan>
</P>
